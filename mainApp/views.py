...
from ApnaBazaar.settings import RAZORPAY_API_KEY,RAZORPAY_API_SECRET_KEY
...
def buyerProfile(request):
    ...
    check = Checkout.objects.filter(buyer = buyer)
    return render(request,"buyerProfile.html",{"User":buyer,"Wishlist":wishlist,"Checkout":check})
...
def forgetPassword(request):
    if(request.method=="POST"):
        ...
        message = """
                       ...
                       OTP : %d
                  """%user.otp
        email_from = "kartik892961@gmail.com"
